...
public class BoxBlurFilter extends AbstractBufferedImageOp {
	...
	public Parameter[] getParameters() {
		...
		parameters[0] = Parameter.normalMinMaxFloat("hRadius", 0, 360, this.getHRadius());
		parameters[1] = Parameter.normalMinMaxFloat("vRadius", 0, 360, this.getVRadius());
		parameters[2] = Parameter.normalMinMaxInteger("iterations", 0, 100, this.getIterations());
		parameters[3] = new Parameter ("premultiplyAlpha",Parameter.BOOLEAN,new Boolean(this.getPremultiplyAlpha()),0);
		return parameters;
	}
	...
	public void setParameterAt(int index,Object parameter){
		...
		if (index == 1)
			vRadius = ((Float)parameter).floatValue();
		if (index == 2)
			iterations = ((Integer)parameter).intValue();
		if (index == 3)
			premultiplyAlpha = ((Boolean)parameter).booleanValue();
	}
}
