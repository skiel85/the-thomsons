...
public class BicubicScaleFilter extends AbstractBufferedImageOp {
	...
	public Parameter[] getParameters() {
		...
		parameters[0] = Parameter.normalMinMaxInteger("width", 0, 2000, width);
		parameters[1] = Parameter.normalMinMaxInteger("height", 0, 2000, height);
		return parameters;
	}
	
	public void setParameterAt(int index,Object parameter){
		if (index == 0)
			width = ((Integer)parameter).intValue();
		if (index == 1)
			height = ((Integer)parameter).intValue();
	}
